...
RSpec.describe Api::V1::Mobile::Family, dbclean: :after_each do
  include_context 'employer_data'

  context 'Family' do

    it 'should return HBX enrollments' do
      family = Api::V1::Mobile::Family.new benefit_group_assignment_ids: [benefit_group_assignment.id], aasm_states: ['coverage_selected']
