Feature: HBX-Admin needs to add a self-attested SEP for an enrollment/household

	As an HBX-admin I need to be able to add a self-attested SEP for an enrollment
	or household.
	...
	Scenario Outline: add self-attested SEP for an enrollment/household
